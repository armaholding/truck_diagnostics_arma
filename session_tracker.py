...
def log_session(
    ...
    Returns:
        Generated session UUID string (e.g., "going1-550e...")
    """
    # Normalize inputs
    ...
    try:
        with open(csv_path, 'a', newline='', encoding='utf-8') as f:
            writer = csv.DictWriter(f, fieldnames=[
                ...
                'plate_number', 'driver', 
                'broken_component', 'working_component'
            ])
...
def main(
    ...
    """
    Main entry point for session tracking.
...
if __name__ == "__main__":
    print(f"{BLUE}🚛 Session Tracker - Realistic Fleet Operations Test{RESET}\n")
    ...
    # test_start = "2026-01-27 06:30:15"
    # test_finish = "2026-01-27 06:33:40"
    # test_plate = "ABC 123"
    ...
    # uuid1 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    # print(f"Generated UUID: {uuid1}\n")
    
    # test_start = "2026-01-27 18:45:22"
    # test_finish = "2026-01-27 18:48:55"
    # test_plate = "ABC 123"
    # test_driver = ["Alvin Hernandez"]
    # test_broken = []
    # test_working = [
    ...
    # uuid2 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    ...
    # test_start = "2026-01-27 07:15:10"
    # test_finish = "2026-01-27 07:18:30"
    # test_plate = "XYZ 789"
    ...
    # uuid3 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    # print(f"Generated UUID: {uuid3}\n")
    
    # test_start = "2026-01-27 19:20:05"
    # test_finish = "2026-01-27 19:23:40"
    # test_plate = "XYZ 789"
    # test_driver = ["Maria Garcia"]
    ...
    # uuid4 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    ...
    # test_start = "2026-01-27 06:50:20"
    # test_finish = "2026-01-27 06:53:45"
    # test_plate = "DEF 456"
    ...
    # uuid5 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    # print(f"Generated UUID: {uuid5}\n")
    
    # test_start = "2026-01-27 17:55:30"
    # test_finish = "2026-01-27 17:59:10"
    # test_plate = "DEF 456"
    # test_driver = ["Carlos Rodriguez"]
    # test_broken = [
    ...
    # uuid6 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    ...
    # test_start = "2026-01-27 20:10:15"
    # test_finish = "2026-01-27 20:13:40"
    # test_plate = "GHI 789"
    # test_driver = ["Alvin Hernandez"]
    # test_broken = []
    # test_working = [
    ...
    # uuid7 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    # print(f"Generated UUID: {uuid7}\n")
    
    # test_start = "2026-01-27 23:45:10"
    # test_finish = "2026-01-27 23:48:35"
    # test_plate = "GHI 789"
    # test_driver = ["Alvin Hernandez"]
    ...
    # uuid8 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    ...
    # test_start = "2026-01-27 21:30:05"
    # test_finish = "2026-01-27 21:33:25"
    # test_plate = "XYZ 789"
    ...
    # uuid9 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    ...
    # test_start = "2026-01-28 06:45:10"
    # test_finish = "2026-01-28 06:48:35"
    # test_plate = "XYZ 789"
    # test_driver = ["Maria Garcia"]
    # test_broken = []
    # test_working = [
    ...
    # uuid10 = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
    # print(f"Generated UUID: {uuid10}\n")
    
    # print(f"{BLUE}✅ REALISTIC FLEET OPERATIONS TEST COMPLETED{RESET}")

    session_uuid = main(test_start, test_finish, test_plate, test_driver, test_broken, test_working)
